...
with open('dataset_YDIP_copy.csv', 'r') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter='\t')

# New file for writing unique nodes
    with open('YDIP_NodeSet.csv', 'w', newline='') as new_file:
...
with open('YDIP_NodeSet.csv', 'r') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter='\t')

# Opening data set file
    with open('dataset_YDIP_copy.csv', 'r') as csv_file2:
        csv_reader2 = csv.reader(csv_file2, delimiter='\t')

# To write nodes, its surrounding nodes and its degree
        with open('YDIP_NodeSet_2.csv', 'w', newline='') as new_file:
            csv_writer = csv.writer(new_file, delimiter='\t')
...
with open('YDIP_NodeSet_2.csv', 'r') as csv_file:
    csv_reader = csv.reader(csv_file, delimiter='\t')

    with open('YDIP_NodeSet_2.csv', 'r') as csv_file2:
        csv_reader2 = csv.reader(csv_file2, delimiter='\t')

        with open('YDIP_NodeSet_3.csv', 'w', newline='') as new_file:
            csv_writer = csv.writer(new_file, delimiter='\t')
...
with open('YDIP_NodeSet_2.csv', 'r') as csv_file:
    ...
    with open('YDIP_NodeSet_3.csv', 'r') as csv_file2:
        csv_reader2 = csv.reader(csv_file2, delimiter='\t')

        # to write the node weight of respective nodes
        with open('YDIP_NodeSet_4.csv', 'w', newline='') as new_file:
            csv_writer = csv.writer(new_file, delimiter='\t')
