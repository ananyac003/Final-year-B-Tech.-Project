...
template<class T> ostream& operator<<(ostream& o, const matrix<T>& M);
...
class matrix {
   ...
   public:
	  ...
	  /*The <> after the name of the friend function is needed to make clear that
	  the friend is a template function.
	  */
